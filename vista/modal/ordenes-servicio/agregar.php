...
<input type="hidden" name="tipo" id="" class="form-control" value="OS">
...
<input type="text" name="ot" id=""  required="" class="form-control" maxlength="100" onchange="Mayusculas(this)" autocomplete="off">
</div>
</div>
</div>
