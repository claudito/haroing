...
<input type="hidden" name="tipo" id="" class="form-control" value="RS">
...
<input type="text" name="ot" id=""  required="" class="form-control" maxlength="100" onchange="Mayusculas(this)">
</div>
</div>
</div>
