...
<div class="panel panel-default">
	...
	<table  id="consulta" class="table table-bordered table-condensed">
		...
		<td>
		<a href="<?php echo PATH; ?>docs/pdf/reporte/rs?id=<?php echo $value['numero']; ?>" class="btn btn-warning btn-xs" target="_blank"><i class="glyphicon glyphicon-print"></i></a>
		<a href="rq-servicio-detalle?codigo=<?php echo $value['numero'];?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
